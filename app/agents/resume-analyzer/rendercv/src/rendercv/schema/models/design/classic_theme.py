...
from superplaced-cv.schema.models.base import BaseModelWithoutExtraKeys
from superplaced-cv.schema.models.design.color import Color
from superplaced-cv.schema.models.design.font_family import FontFamily as FontFamilyType
from superplaced-cv.schema.models.design.typst_dimension import (
    TypstDimension,
